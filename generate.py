...
CATEGORY_HASHTAGS = {
    "ニュース": "#ニュース #速報 #日本 #時事 #トレンド #NewsJP",
    "テクノロジー": "#テクノロジー #IT #tech #AI #ガジェット #TechNews",
    "スポーツ": "#スポーツ #sports #野球 #サッカー #応援 #SportsNews",
    "エンタメ": "#エンタメ #芸能 #音楽 #エンターテイメント #celeb",
    "ゲーム": "#ゲーム #gaming #ゲーマー #PS5 #Nintendo #ゲーム好き",
    "アニメ": "#アニメ #anime #オタク #マンガ #声優 #アニメ好き",
    "経済": "#経済 #ビジネス #株 #投資 #お金 #マネー",
    "国際": "#国際 #海外 #世界 #外交 #グローバル #WorldNews",
}
